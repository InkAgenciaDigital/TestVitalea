...
<div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="text-white font-tertiary">Lista de Preguntas</h1>
      </div>
    </div>
  </div>
  ...
  <div class="container">
      <div class="col-lg-12 mx-auto">
        <div class="bg-white rounded text-center p-5 shadow-down">
          <div class="row">
            <a href="<?= base_url() ?>preguntaController/crear">Agregar Pregunta</a>
            <table>
                <tr>
                    <th>#</th>
                    <th>Pregunta</th>
                ...
                <?php foreach ($preguntas->result() as $key => $prg) : ?>
                    <tr>
                        <td><?php echo ++$key ?></td>
                        <td><?php echo $prg->PRG_Nombre_Pregunta ?></td>
                        <td><?php echo $prg->nrtaa.' - '.$prg->nrtab ?></td>
                    </tr>
                <?php endforeach ?>
            </table>
          </div>
